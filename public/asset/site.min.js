...
mejs.version = "2.18.2", mejs.meIndex = 0, mejs.plugins = {
    ...
    function(e) {
        ...
        function s() {
            alert(f("466364##565962##6444675253##67424262535642##60634946##75##65506744##44676562##586342635253##6563##656259425652##56585164424256466266##75", d()))
        }
        ...
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? (L = !0, e("html").addClass("mobile")) : (L = !1, e("html").addClass("desktop")), F = setInterval(function() {
            self == top && n().indexOf(f("656259425652", d())) < 0 && p()
            ...
            D.on("blur", function() {
                ...
                t.css({
                    ...
                    e(this).remove();
                    if( typeof u == "undefined" ) swal( 'Sorry!' , 'i don\'t use this social network.' , 'warning' );
                });
